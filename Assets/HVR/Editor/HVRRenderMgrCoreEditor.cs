...
public class HVRRenderMgrCoreEditor : UnityEditor.Editor
{
	...
	public override void OnInspectorGUI ()
	{
        ...
        SerializedProperty PartitionedRenderingStatus = serializedObject.FindProperty("PartitionedRenderingStatus");
        EditorGUILayout.PropertyField(PartitionedRenderingStatus);
